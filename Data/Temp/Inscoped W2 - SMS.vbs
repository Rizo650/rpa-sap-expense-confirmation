...
session.findById("wnd[0]/usr/ctxtS_PDATE-LOW").text = "01.04.2025"
session.findById("wnd[0]/usr/ctxtS_PDATE-HIGH").text = "30.04.2025"
...
session.findById("wnd[1]/usr/tblSAPLSE16NMULTI_OR_TC/ctxtGS_MULTI_OR-LOW[2,0]").text = "101010"
...
session.findById("wnd[2]/tbar[0]/btn[0]").press
session.findById("wnd[1]/usr/tblSAPLSE16NMULTI_OR_TC/ctxtGS_MULTI_OR-LOW[2,0]").text = "15.04.2025"
session.findById("wnd[1]/usr/tblSAPLSE16NMULTI_OR_TC/ctxtGS_MULTI_OR-HIGH[3,0]").text = "27.05.2025"
...
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "Raw Import Expense W2 - SMS_27052025.xlsx"

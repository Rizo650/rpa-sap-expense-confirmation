...
session.findById("wnd[2]/tbar[0]/btn[0]").press
session.findById("wnd[1]/usr/tblSAPLSE16NMULTI_OR_TC/ctxtGS_MULTI_OR-LOW[2,0]").text = "15.05.2025"
session.findById("wnd[1]/usr/tblSAPLSE16NMULTI_OR_TC/ctxtGS_MULTI_OR-HIGH[3,0]").text = "02.06.2025"
...
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "Raw Import Expense W2 - BP_04062025.xlsx"

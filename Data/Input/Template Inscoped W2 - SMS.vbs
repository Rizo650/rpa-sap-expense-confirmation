...
session.findById("wnd[2]/tbar[0]/btn[0]").press
session.findById("wnd[1]/usr/tblSAPLSE16NMULTI_OR_TC/ctxtGS_MULTI_OR-LOW[2,0]").text = "{{startDateW2}}"
...
session.findById("wnd[1]/usr/ctxtDY_FILENAME").text = "{{fileInscopedSMS}}"
